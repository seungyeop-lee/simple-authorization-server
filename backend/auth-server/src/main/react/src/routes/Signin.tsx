                ...
                <div className="grow flex flex-col justify-center items-center lg:basis-1/2">
                    <div className="w-2/5 min-w-96 max-w-screen-sm">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-slate-400 mt-3">Enter your email below to create your account</p>
                        </div>
                        <div className="grid gap-6 mt-7">
                            <div>
                                <OutlinedInput size="small" placeholder="name@example.com" fullWidth autoComplete="email"/>
                                <Button fullWidth size="medium" className="mt-3 text-sm text-white bg-black hover:bg-slate-900">Sign In with Email</Button>
                            </div>
                            ...
                            <Button fullWidth size="medium" variant="outlined" color="inherit" className="mt-3 text-sm text-black bg-white hover:bg-slate-50">
